...
public class FixturePrimeraFaseServicioTest
{
    ...
    public void Inicializar()
    {
        ...
        var rankingDinamico = new RankingDinamicoServicio(_equipoRepositorio, _auditoriaMock.Object);
    ...
    public void GenerarFixture_AsignaEstadiosOrdenadosPorNombreNormalizado()
    {
        ...
        _contexto.Add(new Estadio("Monumental", "Buenos Aires", "descrip", 84000));
    ...
    public void GenerarFixturePrimeraFase_DebeRegistrarAuditoria()
    {
        ...
        _contexto.Add(new Estadio("Estadio 1", "Ciudad 1", "Desc", 40000));
